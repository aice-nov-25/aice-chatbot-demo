...
- [AICE Course Materials](../../../)

## 🤝 Contributing

This is a teaching demo for the AICE course. Feel free to experiment and modify the code to learn more about AI development!

## 📄 License

Educational use only - part of the AICE course curriculum.